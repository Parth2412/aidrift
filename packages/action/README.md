...
Pin the Action to the immutable `v0.9.0-beta.1` repository tag. Repository development validates the checked-in bundle with `pnpm test:built-action` before each release.
