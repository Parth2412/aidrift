...
- Added a complete `0.9.0-beta.1` offline example whose unchanged check exits `0` and supplied behavioral regression exits `1` with artifact and statistical evidence.
